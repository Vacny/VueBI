...
export default echartsStaticData = {
  getEchartsData: function (type) {
    switch (type) {
      ...
      case state.DISPLAY_LINE_CHART_TWO: {
        ...
        if (type == state.DISPLAY_LINE_CHART_ONE) {
      ...
      case state.DISPLAY_SCATTER_CHART_ONE : {
        ...
        } else if (type == state.DISPLAY_BAR_CHART_FOUR) {

          this.option_title_text = '堆叠条形图';
        } else if (type == state.DISPLAY_SCATTER_CHART_ONE) {
